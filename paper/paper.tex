...
I am starting with the vision for this project. 
...
Filmgrail is an app to check where you are able to watch the movie or television series you have selected. What makes Filmgrail unique in a Norwegian context, is that it covers many of the Norwegian streaming services. \cite{AmundsenAppenAftenposten}. At the moment, however 
\section{Google Assistant}\index{googleassistant}
Google Assistant can also recommend movies.

\begin{figure}[]
  \centering
   \includegraphics[width=0.77\textwidth]{google_assitant.png}
  \caption{Usage of payment instrument millions of transactions (in Norway) 2001 to 2014\cite{Bank2014NoregsKunderetta}}
  \label{fig:use_of_payment_instrument}
\end{figure}
